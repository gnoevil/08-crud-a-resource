(function(module) {
  ...
  Article.createTable = function() {
    ...
    webDB.execute(
      'CREATE TABLE  IF NOT EXISTS articles(id INTEGER PRIMARY KEY, title VARCHAR(50), category VARCHAR(50), author VARCHAR(50), authorUrl VARCHAR(50), publishedOn DATETIME, body TEXT);', // TODONE: What SQL command do we run here inside these quotes?
      function() {
